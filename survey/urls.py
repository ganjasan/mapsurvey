...
urlpatterns = [
    ...
    path('editor/import/jobs/', views.editor_import_jobs, name='editor_import_jobs'),
    path('editor/import/jobs/<int:job_id>/dismiss/', views.editor_import_job_dismiss, name='editor_import_job_dismiss'),
    ...
    path('editor/surveys/<uuid:survey_uuid>/rename/', editor_views.editor_survey_rename, name='editor_survey_rename'),
    ...
    path('editor/surveys/<uuid:survey_uuid>/basemap-image/', editor_views.editor_image_basemap, name='editor_image_basemap'),
    path('editor/surveys/<uuid:survey_uuid>/basemap-image/upload/', editor_views.editor_image_basemap_upload, name='editor_image_basemap_upload'),
    path('editor/surveys/<uuid:survey_uuid>/basemap-image/mode/', editor_views.editor_image_basemap_mode, name='editor_image_basemap_mode'),
    path('editor/surveys/<uuid:survey_uuid>/basemap-image/clear/', editor_views.editor_image_basemap_clear, name='editor_image_basemap_clear'),
    ...
    path('pro/', views.pro_early_access, name='pro_early_access'),
