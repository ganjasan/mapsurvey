# question-subtext Specification

## Purpose

Where a question's subtext reaches the respondent, per input type — including the two types that
deliberately do not show their name.
## Requirements
