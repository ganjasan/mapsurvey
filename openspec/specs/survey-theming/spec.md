...
## Purpose
Light per-survey appearance control: one accent color applied to respondent surfaces, and the validation that keeps a stored style value from becoming CSS injection.
