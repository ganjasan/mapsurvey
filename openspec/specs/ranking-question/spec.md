# ranking-question Specification

## Purpose

What a ranking question asks of the respondent — a strict total order over the creator's items —
what is stored, what is refused, and how ranks leave the platform.
## Requirements
