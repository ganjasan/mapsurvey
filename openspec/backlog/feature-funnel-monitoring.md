...
- **2026-06-10 analysis raises the priority of this item**: a weekly time-series showed response volume does NOT predict registrations (lag-correlation ≈ 0; the only positive correlation came from one external event, the FTSPK class). We literally cannot tell which channel drives signups without source attribution. This is the hard prerequisite for the [growth epic](epics/growth.md) — don't scale acquisition while blind.
